...
kubectl exec $kibana_container -- curl  --show-error -s -o /dev/null -X POST 'http://localhost:5601/api/saved_objects/_import?overwrite=true' -H 'kbn-xsrf: true' --form file=@/tmp/saved_objects/kibana_dashboards_oss_7.10.2.ndjson
